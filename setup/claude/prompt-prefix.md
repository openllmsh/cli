...
NEVER spawn sub-agents without specifying the model
ALWAYS spawn sub-agents in the same worktree by OMITTING the `isolation` field (that is the default); NEVER pass isolation:"worktree" or "remote"
